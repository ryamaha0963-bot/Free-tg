...
# ==================== CORRECTED IMAGE FILE IDs ====================
# 👇 Swapped welcome and profile – ab sahi hai!
MEDIA_MAPPING = {
    "welcome": "AgACAgUAAxkBAAICPWpiIWYRTlYmoNtf5YAMo4moOmHrAAIYE2sbpi4QV3bwmESz182zAAgBAAMCAAN5AAceBA",   # Profile image (but now for welcome)
    "profile": "AgACAgUAAxkBAAICQGpiIin66ZiZAAE8w5w-TfLrYKGNFwACGhNrG6YuEFcAARIpUDBtUDkACAEAAwIAA3kABx4E",   # Welcome image (now for profile)
    ...
    def __init__(self, app: Client):
        ...
        async def callback_handler(client, callback):
            ...
            if data in screen_map:
                await self._show_screen(client, old_msg, screen_map[data], user_id)
