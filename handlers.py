...
# ========== SWAPPED MEDIA MAPPING ==========
# Welcome aur Profile ke IDs swap kar diye gaye hain
MEDIA_MAPPING = {
    "welcome": "AgACAgUAAxkBAAICPWpiIWYRTlYmoNtf5YAMo4moOmHrAAIYE2sbpi4QV3bwmESz182zAAgBAAMCAAN5AAceBA",  # Pehle profile ID
    "profile": "AgACAgUAAxkBAAICQGpiIin66ZiZAAE8w5w-TfLrYKGNFwACGhNrG6YuEFcAARIpUDBtUDkACAEAAwIAA3kABx4E",  # Pehle welcome ID
...
class BotHandlers:
    ...
    async def _show_screen(self, client, target, screen, user_id, is_edit=False):
        ...
        try:
            ...
            logger.error(f"Media failed for {screen}: {e}")
            if is_edit:
                await msg.edit_text(
