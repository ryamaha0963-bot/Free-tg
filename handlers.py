...
class BotHandlers:
    def __init__(self, app: Client):
        ...
        async def start_cmd(client, message):
            ...
            keyboard = [
                [InlineKeyboardButton("👤 My Account", callback_data="stats")],
            ...
            # ---------- SEXY WELCOME DESCRIPTION ----------
            await message.reply(
                "🌟 **Welcome to Diamond Referral Bot** 🌟\n\n"
                "💎 Earn **Telegram Accounts** by inviting your friends!\n"
                "🔥 **1 Referral = 1 Diamond**\n"
                f"🎁 **{DIAMOND_COST} Diamonds = 1 Telegram Account**\n"
                "💯 **100% Trusted & Secure**\n\n"
        ...
        async def callback_handler(client, callback: CallbackQuery):
            ...
            if data == "stats":
                ...
                await callback.message.edit_text(
                    ...
                    f"🎯 **Next account in:** `{next_target}` diamond(s)\n\n"
