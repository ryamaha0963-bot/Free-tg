...
class BotHandlers:
    def __init__(self, app: Client):
        ...
        async def callback_handler(client, callback: CallbackQuery):
            ...
            # ---------- ADMIN PANEL (UPGRADED WITH INLINE BUTTONS) ----------
                ...
                await callback.message.edit_text(
                    "🔧 **Admin Panel**\n\n"
                    "Click any button to get the command format or execute.\n"
                    "⚠️ Commands needing input will show usage guide.",
            ...
            # ---------- ADMIN INLINE BUTTON HANDLERS ----------
                ...
                await callback.message.edit_text(
                    ...
                    "You will receive OTP instructions.",
                ...
                await callback.message.edit_text(
                    "📲 **Complete OTP**\n\n"
                    "After receiving OTP, send:\n"
                    "`/otp +911234567890 12345`\n\n"
                    "Replace phone and OTP code.",
                    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔙 Back to Admin", callback_data="admin_panel")]]),
                    parse_mode=ParseMode.MARKDOWN
                )
                await callback.answer()
                ...
                await callback.message.edit_text(
                    ...
                    "Replace all fields accordingly.",
                    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔙 Back to Admin", callback_data="admin_panel")]]),
                    parse_mode=ParseMode.MARKDOWN
                )
                await callback.answer()
                ...
                # Directly trigger the listaccounts command
                await callback.message.reply("/listaccounts")
                await callback.answer()
                # Optionally go back to admin panel after a moment? But let it be.
        ...
        # ---------- ADMIN COMMANDS (unchanged, but keep them for direct use) ----------
