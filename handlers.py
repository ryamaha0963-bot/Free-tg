...
# ========== SAHI FILE IDs (Aapke order ke hisaab se) ==========
MEDIA_MAPPING = {
    "welcome": "AgACAgUAAxkBAAICPWpiIWYRTlYmoNtf5YAMo4moOmHrAAIYE2sbpi4QV3bwmESz182zAAgBAAMCAAN5AAceBA",    # 1st ID
    "profile": "AgACAgUAAxkBAAICQGpiIin66ZiZAAE8w5w-TfLrYKGNFwACGhNrG6YuEFcAARIpUDBtUDkACAEAAwIAA3kABx4E",   # 2nd ID
    "invite": "AgACAgUAAxkBAAICQ2piIurs4zuoexABkKldhri2QX7IAAIcE2sbpi4QV6pQ9mA2CAugAAgBAAMCAAN5AAceBA",    # 3rd ID
    "rewards": "AgACAgUAAxkBAAICRmpiI3NqRzzURxr0z-kN31yRfRl0AAIdE2sbpi4QV0zq454LY2_PAAgBAAMCAAN5AAceBA",   # 4th ID
    "my_rewards": "AgACAgUAAxkBAAICRmpiI3NqRzzURxr0z-kN31yRfRl0AAIdE2sbpi4QV0zq454LY2_PAAgBAAMCAAN5AAceBA", # Same as rewards
    "progress": "AgACAgUAAxkBAAICS2piI_FLgEAGxcCJwxDxOgQXiOVZAAIeE2sbpi4QVxY6hrl6jS5pAAgBAAMCAAN5AAceBA",   # 5th ID
    "support": "AgACAgUAAxkBAAICT2piJGMMLPKdjUI9n2N2KqwAAVWZKwACIRNrG6YuEFfJP48Z1gPnlgAIAQADAgADeQAHHgQ",  # 6th ID
    "admin": "AgACAgUAAxkBAAICUmpiJLi1RXiYSQWJj2Eg5rcJTBpvAAIjE2sbpi4QV3VpkdHjPokXAAgBAAMCAAN5AAceBA",      # 7th ID
    "admin_broadcast": "AgACAgUAAxkBAAICVWpiJQpZB3c0xVHgOpdhbiliInPoAAIkE2sbpi4QVyqn1zaowZUBAAgBAAMCAAN5AAceBA", # 8th ID
}
...
class BotHandlers:
    def __init__(self, app: Client):
        ...
        async def callback_handler(client, callback):
            ...
            # ---------- SCREEN NAVIGATION (Delete + Send New) ----------
            screen_map = {
                "welcome": "welcome",
                "profile": "profile",
                "invite": "invite",
    ...
    async def _show_screen(self, client, target, screen, user_id, is_edit=False):
        ...
        caption = captions.get(screen, "⚠️ Screen not found.")
        ...
        try:
            ...
            logger.error(f"Photo send failed for {screen}: {e}")
            await client.send_message(
                chat_id=chat_id,
